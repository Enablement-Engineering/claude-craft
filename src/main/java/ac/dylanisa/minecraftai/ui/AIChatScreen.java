...
import ac.dylanisa.minecraftai.network.ClientChatHandler;
import ac.dylanisa.minecraftai.network.ClientboundConversationListPacket.ConversationSummary;
import ac.dylanisa.minecraftai.network.ServerboundChatPacket;
import ac.dylanisa.minecraftai.network.ServerboundDeleteConversationPacket;
import ac.dylanisa.minecraftai.network.ServerboundNewConversationPacket;
import ac.dylanisa.minecraftai.network.ServerboundRequestConversationsPacket;
import ac.dylanisa.minecraftai.network.ServerboundResumeConversationPacket;
...
public class AIChatScreen extends ModularUIScreen {
    ...
    public AIChatScreen() {
        ...
        super(ModularUI.of(createPlaceholderUI()), Component.translatable("screen.minecraftai.chat"));
    }
    ...
    private UIElement createSidePanel() {
        ...
        if (panelExpanded) {
            ...
            panelTitle.setText(Component.translatable("screen.minecraftai.chat.conversations"));
            ...
            newButton.setText(Component.translatable("screen.minecraftai.chat.new"));
    ...
    private UIElement createTitleBar() {
        ...
        var title = new Label();
        title.setText(Component.translatable("screen.minecraftai.chat.title"));
        ...
        if (!panelExpanded) {
            ...
            historyButton.setText(Component.translatable("screen.minecraftai.chat.history"));
    ...
    private UIElement createInputArea() {
        ...
        sendButton.setText(Component.translatable("screen.minecraftai.chat.send"));
    ...
    private void resumeConversation(String sessionId) {
        MinecraftAI.LOGGER.info("Resuming conversation: {}", sessionId);
        messages.clear();
    ...
    private void deleteConversation(String sessionId) {
        MinecraftAI.LOGGER.info("Deleting conversation: {}", sessionId);
