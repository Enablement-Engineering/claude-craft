package ac.dylanisa.minecraftai;
...
/**
 * Minecraft AI - An AI-powered assistant using Claude Code in headless mode.
 *
 * This mod provides:
...
public class MinecraftAI {
    ...
    public MinecraftAI(IEventBus modEventBus, ModContainer modContainer) {
        ...
        LOGGER.info("Minecraft AI mod initialized");
    }

    private void commonSetup(final FMLCommonSetupEvent event) {
        LOGGER.info("Minecraft AI common setup");
    }

    @SubscribeEvent
    public void onServerStarting(ServerStartingEvent event) {
        LOGGER.info("Minecraft AI: Server starting, initializing plugin directory...");

        try {
            dataManager = new PlayerDataManager(event.getServer());
            dataManager.initialize();
            LOGGER.info("Minecraft AI: Plugin directory initialized at {}",
                dataManager.getPluginDir());
        } catch (Exception e) {
            LOGGER.error("Failed to initialize Minecraft AI plugin directory", e);
        }
    }
    ...
    public void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        try {
            ...
            ac.dylanisa.minecraftai.network.ChatSessionManager.newConversation(player.getUUID());
