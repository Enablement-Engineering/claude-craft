...
public class ClientChatHandler {
    ...
    public static void onChatChunk(String text) {
        ...
        MinecraftAI.LOGGER.debug("Received chat chunk: {}", text);
    }
    ...
    public static void onChatComplete(boolean success, String errorMessage) {
        ...
        if (!success) {
            MinecraftAI.LOGGER.warn("Chat failed: {}", errorMessage);
        }
    ...
    public static void onScratchPadSync(String content) {
        MinecraftAI.LOGGER.info("ClientChatHandler: onScratchPadSync received {} chars, callback={}",
