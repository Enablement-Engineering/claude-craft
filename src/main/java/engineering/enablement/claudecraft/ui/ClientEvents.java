...
import engineering.enablement.claudecraft.ui.overlay.OverlayManager;
...
/**
 * Client-side event handling for the Claude Craft mod.
 */
...
public class ClientEvents {
    ...
    private static void toggleChatOverlay() {
        ...
        ClaudeCraft.LOGGER.debug("Chat overlay toggled: {}", manager.isOverlayVisible(OverlayType.CHAT));
    }
    ...
    private static void toggleScratchPadOverlay() {
        ...
        ClaudeCraft.LOGGER.debug("Scratch pad overlay toggled: {}", visible);
    ...
    private static void hideAllOverlays() {
        ...
        ClaudeCraft.LOGGER.debug("All overlays hidden");
    }
}
