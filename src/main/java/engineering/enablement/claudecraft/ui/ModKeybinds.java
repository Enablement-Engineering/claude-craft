...
/**
 * Keybind registration for the Claude Craft mod.
 */
@EventBusSubscriber(modid = ClaudeCraft.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class ModKeybinds {

    public static final String KEY_CATEGORY = "key.categories.claudecraft";

    public static final KeyMapping OPEN_CHAT = new KeyMapping(
        "key.claudecraft.open_chat",
    ...
    public static final KeyMapping OPEN_SCRATCHPAD = new KeyMapping(
        "key.claudecraft.open_scratchpad",
        KeyConflictContext.IN_GAME,
        InputConstants.Type.KEYSYM,
    ...
    public static final KeyMapping TOGGLE_CHAT_OVERLAY = new KeyMapping(
        "key.claudecraft.toggle_chat_overlay",
        KeyConflictContext.IN_GAME,
        InputConstants.Type.KEYSYM,
    ...
    public static final KeyMapping TOGGLE_SCRATCHPAD_OVERLAY = new KeyMapping(
        "key.claudecraft.toggle_scratchpad_overlay",
        KeyConflictContext.IN_GAME,
        InputConstants.Type.KEYSYM,
    ...
    public static final KeyMapping HIDE_ALL_OVERLAYS = new KeyMapping(
        "key.claudecraft.hide_all_overlays",
        KeyConflictContext.IN_GAME,
        InputConstants.Type.KEYSYM,
    ...
    public static void registerKeyMappings(RegisterKeyMappingsEvent event) {
        ...
        ClaudeCraft.LOGGER.info("Registered Claude Craft keybinds");
    }
}
